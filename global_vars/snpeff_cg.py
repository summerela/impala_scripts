...
class snpeff(object):
    ...
    def __init__(self, spark_host_prefix='hdfs://ip-10-0-0-118.ec2.internal:8020/itmi/', ilmn_db='wgs_cg.db/', \
        ...
        self.in_table = "{}{}{}".format(self.spark_host_prefix, self.ilmn_db, 'cg_vars')
