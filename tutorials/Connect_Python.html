...
<h2 id="Connecting-to-Imapala-with-Python">Connecting to Imapala with Python<a class="anchor-link" href="#Connecting-to-Imapala-with-Python">&#182;</a></h2>
</div>
</div>
</div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Installing the impyla module is as easy as running the following command.</p>
<p>If you have any trouble, more information can be found at: https://github.com/cloudera/impyla</p>
</div>
</div>
</div>
...
<div class="highlight"><pre><span class="n">pip</span> <span class="n">install</span> <span class="n">impyla</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Connecting to impala with Python uses the Python DB-API standards. More info on the DB-API can be found at: http://www.tutorialspoint.com/python/python_database_access.htm</p>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered">
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Basic-database-interaction">Basic database interaction<a class="anchor-link" href="#Basic-database-interaction">&#182;</a></h2>
</div>
</div>
</div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Interacting with impala requires using the execute method on the cursor object, in the format:</p>
<p>cur.execute('sql statement')</p>
<p>Follow this with a cur.fetchall() to grab the results.</p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="kn">from</span> <span class="nn">impala.dbapi</span> <span class="kn">import</span> <span class="n">connect</span>

<span class="c">#create a connection </span>
<span class="n">conn</span><span class="o">=</span><span class="n">connect</span><span class="p">(</span><span class="n">host</span><span class="o">=</span><span class="s">&#39;glados19&#39;</span><span class="p">,</span> <span class="n">port</span><span class="o">=</span><span class="mi">21050</span><span class="p">)</span>

<span class="c">#to connect to specific database, use the database argument</span>
<span class="c">#conn=connect(host=&#39;glados19&#39;, port=21050, database=&quot;public_hg19&quot;)</span>

<span class="c">#create a cursor object to interact with the db</span>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h3 id="View-available-databases-and-tables">View available databases and tables<a class="anchor-link" href="#View-available-databases-and-tables">&#182;</a></h3>
</div>
</div>
</div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>To see what dabases are available in impala, let's run a simple SQL statement:</p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c">#view databases</span>
<span class="n">cur</span><span class="o">.</span><span class="n">execute</span><span class="p">(</span><span class="s">&#39;SHOW DATABASES&#39;</span><span class="p">)</span>
<span class="c">#fetch results of cur.execute</span>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Let's take a look at the public resources available for the hg19 build by first selecting which database to use, and then asking to see all the tables in that database:</p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c">#select a particular database to use</span>
<span class="n">cur</span><span class="o">.</span><span class="n">execute</span><span class="p">(</span><span class="s">&#39;USE public_hg19&#39;</span><span class="p">)</span>
<span class="c">#view tables in selected database </span>
<span class="c">#if no db is selected, you will see tables in default db</span>
<span class="n">cur</span><span class="o">.</span><span class="n">execute</span><span class="p">(</span><span class="s">&#39;SHOW TABLES&#39;</span><span class="p">)</span>
<span class="k">print</span> <span class="n">cur</span><span class="o">.</span><span class="n">fetchall</span><span class="p">()</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>
[(&apos;clinvar&apos;,), (&apos;clinvar_summary&apos;,), (&apos;cytoband&apos;,), (&apos;dbsnp&apos;,), (&apos;ensembl_genes&apos;,), (&apos;esp_exomes&apos;,), (&apos;kaviar&apos;,), (&apos;mirbase&apos;,), (&apos;pfam_clans&apos;,), (&apos;pfam_regions&apos;,), (&apos;refseq&apos;,), (&apos;refseq_map&apos;,), (&apos;repeatmasker&apos;,), (&apos;ucsc&apos;,), (&apos;ucsc_segdup&apos;,)]
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h3 id="Viewing-table-information">Viewing table information<a class="anchor-link" href="#Viewing-table-information">&#182;</a></h3>
</div>
</div>
</div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>In order to match up fields from different tables, it helps to have more information about what each table contains. The SQL &quot;DESCRIBE&quot; statement can be used to find out column names, data types and a description of the contents:</p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="n">cur</span><span class="o">.</span><span class="n">execute</span><span class="p">(</span><span class="s">&#39;DESCRIBE public_hg19.cytoband&#39;</span><span class="p">)</span>
...
[(&apos;chrom&apos;, &apos;string&apos;, &apos;Chromosome number&apos;),
 (&apos;chromstart&apos;, &apos;int&apos;, &apos;Start position in genoSeq&apos;),
 (&apos;chromend&apos;, &apos;int&apos;, &apos;End position in genoSeq&apos;),
 (&apos;name&apos;, &apos;string&apos;, &apos;Name of cytogenetic band&apos;),
 (&apos;giestain&apos;, &apos;string&apos;, &apos;Giesma stain results&apos;)]
</pre>
</div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>For more information on creating queries and interacting with impala, please see Querying Impala.</p>
</div>
</div>
</div>
    </div>
